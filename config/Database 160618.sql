...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 16, 2018 at 03:44 PM
...
(1, 'Test', 'Test', 'Test', 'Pop', 2005, 3, 1, 1, 4, 0, '2018-06-16 15:28:42'),
...
(5, 'Face the Ashes', 'Gob', 'Muertos Vivos', '', 27, 1, 0, 0, 0, 0, NULL),
...
(14, 'Auguri Cha Cha', 'Bob Azzam', 'Arrivederci', '', 0, 0, 0, 0, 0, 0, NULL),
...
(19, 'Caught In A Dream', 'Tesla', 'Gold', '', 24, 0, 0, 1, 0, 0, '2018-06-16 15:38:53'),
(20, 'Synthetic Dream', 'lextrical', 'Whatever Happened To Boredom?', '', 0, 0, 0, 0, 0, 0, NULL),
(21, 'Broken-Down Merry-Go-Round', 'Jimmy Wakely', '1942-1952 Jimmy Wakely', '', 0, 0, 0, 0, 0, 0, NULL),
...
(24, 'Setting Fire to Sleeping Giants', 'The Dillinger Escape Plan', 'Miss Machine', '', 24, 0, 0, 0, 0, 0, NULL),
...
(28, 'I Think My Wife Is Running Around On Me (Taco Hell)', 'Tim Wilson', 'The Real Twang Thang', '', 25, 0, 0, 0, 0, 0, NULL),
...
(37, 'Barking Dogs', 'Butthole Surfers', 'Piouhgd + Widowermaker!', 'Pop', 0, 0, 0, 0, 0, 0, NULL),
...
(41, 'Spin', 'Scarlet\'s Remains', 'The Palest Grey', '', 27, 0, 0, 0, 0, 0, NULL),
(42, 'Burning In The Aftermath', 'The Suicide Machines', 'A Match & Some Gasoline', '', 23, 0, 0, 1, 2, 0, '2018-06-16 15:41:02'),
...
(46, 'Glory Be', 'R.L. Burnside', 'A Bothered Mind', '', 24, 0, 0, 0, 0, 0, NULL),
(47, 'Crossfire', 'Stevie Ray Vaughan', 'Greatest Hits', '', 1992, 0, 0, 0, 0, 0, NULL),
(48, 'I Can\'t Be Satisfied', 'John Hammond', 'Bluesman', '', 22, 0, 0, 0, 0, 0, NULL),
(49, 'Nashville Parthenon', 'Casiotone For The Painfully Alone', 'Etiquette', '', 26, 0, 0, 0, 0, 0, NULL),
...
(52, 'The More I See You', 'Eliane Elias', 'Bossa Nova Stories', '', 29, 0, 0, 0, 0, 0, NULL),
...
(58, 'Tous Les GarASSons Et Les Filles', 'Eurythmics', 'Be Yourself Tonight', '', 1985, 0, 0, 0, 0, 0, NULL),
...
(63, 'Deform (live)', 'The Berzerker', 'The Berzerker', '', 2, 0, 0, 0, 0, 0, NULL),
...
(69, 'Entre CanAbales', 'Soda Stereo', 'CanciA3n Animal', '', 199, 0, 0, 0, 0, 0, NULL),
(70, 'Rosemary Recalls', 'Bruce Rowland', 'The Man from Snowy River', '', 1985, 0, 0, 0, 0, 0, NULL),
(71, 'Sudanese Dance', 'Xcultures', 'One World One People', '', 2, 0, 0, 0, 0, 0, NULL),
...
(75, 'Let\'s Get It Started', 'Black Eyed Peas', 'Total Workout Running 102 - 135 - 84bpm Ideal For Jogging_ Running_ Treadmill & General Fitness', '', 24, 0, 0, 0, 0, 0, NULL),
(76, 'Metal', 'Nine Inch Nails', 'Things Falling Apart', 'Rock', 2, 0, 0, 0, 0, 0, NULL),
...
(80, 'Complicate It', 'Smartbomb', 'Yeah.  Well_ Anyway....', '', 21, 0, 0, 0, 0, 0, NULL),
(81, 'Monde De Fou', 'Suburbs', 'Un Titre de Toune', '', 25, 0, 0, 0, 0, 0, NULL),
...
(85, 'You Feel Good All Over', 'T.G. Sheppard', 'The Very Best Of', '', 22, 0, 0, 0, 0, 0, NULL),
(86, 'Indian Love Call', 'Slim Whitman', 'Country Lovers. Vol. 3', '', 199, 0, 0, 0, 0, 0, NULL),
(87, 'You Can Still Be Free', 'Savage Garden', 'Affirmation', '', 1999, 0, 0, 0, 0, 0, NULL),
(88, 'I Never Came', 'Queens Of The Stone Age', 'Lullabies To Paralyze', 'Rock', 25, 0, 0, 0, 0, 0, NULL),
(89, 'Dixie', 'Hank Penny & The Lincoln Penny Orchestra', 'It\'s War Again', '', 0, 0, 0, 0, 0, 0, NULL),
(90, 'Commercial Reign', 'Inspiral Carpets', 'The Singles', '', 199, 0, 0, 0, 0, 0, NULL),
...
(95, 'WKYA (drop)', 'Redman', 'Malpractice', '', 21, 0, 0, 0, 0, 0, NULL),
